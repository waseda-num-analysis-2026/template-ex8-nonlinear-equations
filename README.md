...
This repository contains **Ex 8.1** and **Ex 8.2** (both **Individual Work**).
...
**IMPORTANT:** This creates `ex8-1.html`, `ex8-2.html`, and the corresponding
`ex8-*_files/` directories.
